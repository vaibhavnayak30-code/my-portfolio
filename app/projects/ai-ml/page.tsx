...
export default function AIMLProjects() {
    ...
    const projects = [
        {
            slug: "credit-rating-prediction",
            title: "Credit Rating & Investment Grade Prediction",
            desc: "Built ML models to classify companies into investment-grade categories using financial data and predictive modeling techniques.",
            image: "/projects_logos/Credit_Rating.png",
            date: "2025",
            tech: ["Python", "Machine Learning", "Logistic Regression", "Neural Networks"],
    ...
    return (
        <main className="max-w-xl mx-auto px-6 mt-12">
            ...
            <h1 className="text-3xl font-bold mb-10">AI / ML Projects</h1>
            ...
            <div className="space-y-10">
                ...
                {projects.map((p) => (
                    ...
                    >
                        ...
                        <Link href={`/projects/ai-ml/${p.slug}`}>
                            <Image
                                src={p.image}
                                alt={p.title}
                                width={800}
